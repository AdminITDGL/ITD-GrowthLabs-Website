...
<head>
    ...
    <meta name="description" content="Design your B2B website for lead generation. Structure, content, CTAs, and conversion strategies from ITD GrowthLabs.">

    <!-- ========== Page Title ========== -->
    <title>B2B Website Design: How to Build a Lead Generation Machine</title>
    ...
    <!-- SEO Optimization -->
    <link rel="canonical" href="https://itdgrowthlabs.com/resources/B2B_Website_Design_Lead_Generation_Focused.php" />
    <meta property="og:title" content="B2B Website Design: How to Build a Lead Generation Machine" />
    <meta property="og:description" content="Design your B2B website for lead generation. Structure, content, CTAs, and conversion strategies from ITD GrowthLabs." />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://itdgrowthlabs.com/resources/B2B_Website_Design_Lead_Generation_Focused.php" />
    <meta property="og:image" content="https://itdgrowthlabs.com/assets/img/logo.jpg" />
    <meta property="og:site_name" content="ITD GrowthLabs" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="B2B Website Design: How to Build a Lead Generation Machine" />
    <meta name="twitter:description" content="Design your B2B website for lead generation. Structure, content, CTAs, and conversion strategies from ITD GrowthLabs." />
                        ...
                        <div class="blog-style-one item">
                            <div class="blog-item-box">
                                <div class="info">
                                    ...
                                    <h2>B2B Website Structure That Generates Leads</h2>
                                    <p>A high-performing B2B website follows this structure:</p><ol><li><strong>Homepage:</strong> Clear positioning, key services, trust signals (stats, logos), and a primary CTA</li><li><strong>Service pages:</strong> One page per service with problems you solve, process, pricing guidance, and case studies</li><li><strong>Industry pages:</strong> Vertical-specific content showing you understand their challenges</li><li><strong>Case studies:</strong> Results with specific metrics (312% traffic growth, 45% lower CPL)</li><li><strong>About page:</strong> Team, history, values — but focused on why clients trust you</li><li><strong>Contact page:</strong> Short form, phone number, WhatsApp, and office location</li><li><strong>Blog:</strong> SEO content targeting questions your prospects ask before buying</li></ol><p><a href="../contact-us.php">Let ITD GrowthLabs</a> build your B2B website as a lead generation engine, not a digital brochure.</p>

                                    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); border-radius: 12px; padding: 30px; margin: 30px 0;">
                                        <h3 style="color: #fff; margin: 0 0 10px; font-size: 22px;">Build Your B2B Website</h3>
