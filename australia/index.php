...
<body>
                    ...
                    <div class="banner-style-three col-lg-7">
                        <div class="information">
                            <h1 class="wow fadeInUp" data-wow-delay="500ms" data-wow-duration="400ms">
                                Top Digital Services Company in Australia
                            </h1>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Australia Digital Services</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">We work with Australian businesses in Sydney, Melbourne, Brisbane, and beyond — delivering websites, mobile apps, and digital marketing campaigns built for the Australian market. Time zone overlap with India means faster turnaround and real-time collaboration. <a href="../contact-us.php">Start your project today →</a></p>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center mb-50">
                        ...
                        <h2 class="title">Digital Services in Australia</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="intro-content-box">
                        <div class="intro-text mb-40">
                            <p class="lead-text">Australia is home to a fast-growing digital economy, where businesses demand reliable technology partners to support growth, automation, and customer engagement.</p>
                            <p>At ITD GrowthLabs, we are a trusted digital services company in Australia, delivering end-to-end solutions including website design &amp; development, web applications, mobile apps, and digital marketing services.</p>
                            <p>We work with startups, SMEs, and enterprises across Australia to build scalable digital systems that drive real business results.</p>
                        </div>
    ...
    <div class="default-padding bg-white">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">WHY AUSTRALIAN BUSINESSES CHOOSE ITD GROWTHLABS</h5>
            ...
            <div class="row mt-40">
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <h4>Australia-Focused Strategy</h4>
                        <p>We understand the Australian market, customer expectations, and digital compliance standards.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
    ...
    <div class="default-padding bg-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">OUR DIGITAL SERVICES IN AUSTRALIA</h5>
                        <h2 class="title">Web, Apps &amp; Marketing — Built for Australian Businesses</h2>
                    </div>
                </div>
            </div>
            <div class="row mt-40">
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Conversion-focused, SEO-optimised websites built for Australian audiences.</p>
                        <a href="../australia/website-design-development.php" class="btn btn-theme btn-sm mt-4">Explore Website Design &amp; Development in Australia <i class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <a href="../australia/web-application-development.php" class="btn btn-theme btn-sm mt-4">Explore Web Application Development in Australia <i class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <a href="../australia/mobile-app-development.php" class="btn btn-theme btn-sm mt-4">Explore Mobile App Development in Australia <i class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>SEO, paid ads, content marketing, and lead generation for Australian businesses.</p>
                        <a href="../australia/digital-marketing-services.php" class="btn btn-theme btn-sm mt-4">Explore Digital Marketing Services in Australia <i class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="process-row">
                    ...
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <p>Custom roadmap aligned with Australian market needs</p>
                        </div>
                    </div>
                    <div class="process-connector"><i class="fas fa-arrow-right"></i></div>
                    <div class="process-hexagon">
    ...
    <div class="default-padding bg-white">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">INDUSTRIES WE SERVE IN AUSTRALIA</h5>
    ...
    <div class="default-padding bg-white">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">DIGITAL SERVICES ACROSS MAJOR AUSTRALIAN CITIES</h5>
                        <h2 class="title">We Serve Businesses Nationwide</h2>
                        <p class="mt-30">We provide professional digital services across Australia, including:</p>
                    </div>
                </div>
            </div>
            <div class="row mt-40">
                <div class="col-lg-3 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <h4>Sydney</h4>
                        <p>Digital services for businesses in Sydney</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-30">
                    <div class="why-choose-card">
                        <div class="icon-wrapper"><i class="fas fa-city"></i></div>
                        <h4>Melbourne</h4>
                        <p>Digital services for businesses in Melbourne</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-30">
                    <div class="why-choose-card">
                        <div class="icon-wrapper"><i class="fas fa-city"></i></div>
                        <h4>Brisbane</h4>
                        <p>Digital services for businesses in Brisbane</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-30">
                    <div class="why-choose-card">
                        <div class="icon-wrapper"><i class="fas fa-city"></i></div>
                        <h4>Perth</h4>
                        <p>Digital services for businesses in Perth</p>
                    </div>
                </div>
            </div>
            <div class="row mt-30">
    ...
    <div class="default-padding bg-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">WHY ITD GROWTHLABS IS A LEADING DIGITAL COMPANY IN AUSTRALIA</h5>
                        <h2 class="title">Your Trusted Digital Partner</h2>
                    </div>
                </div>
            </div>
    ...
    <div class="knowledge-hub-area overflow-hidden default-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">FAQ – DIGITAL SERVICES IN AUSTRALIA</h5>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                        Do you work with Australian businesses remotely?
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we support Australian clients remotely with structured communication and delivery processes.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        Do you offer SEO and digital marketing in Australia?
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we provide Australia-focused SEO, paid ads, and digital marketing services.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                        Which Australian cities do you serve?
                                    </button>
                                </h2>
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        We serve businesses across Sydney, Melbourne, Brisbane, Perth, and other regions.
                                    </div>
                                </div>
                            </div>
                        </div>
