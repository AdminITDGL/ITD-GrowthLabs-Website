                            ...
                            <div class="form-content p-3">
                                ...
                                <form id="appDevelopmentForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <button type="submit" class="btn btn-primary w-100">Talk to an Australia Digital Expert <i class="fas fa-arrow-up" style="margin-left: 8px;rotate: 45deg;"></i></button>
                                        </div>
                                    </div>
