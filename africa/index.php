   ...
   <?php include("header.php") ?>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Africa Digital Services</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">We partner with businesses across Africa — from Nigeria and Kenya to South Africa and Ghana — delivering websites, mobile apps, and digital marketing that drive growth in rapidly expanding African markets. Let us be your technology partner for the continent. <a href="../contact-us.php">Explore our Africa services →</a></p>
        </div>
    </div>
