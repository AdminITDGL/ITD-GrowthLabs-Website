...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    itdgl_log_lead('websiteDesignForm', compact('full_name', 'company_name', 'email', 'phone', 'website_type', 'message'));
    ...
    try {
        ...
        itdgl_log_mail_failure('websiteDesignForm', $e->getMessage(), ['name' => $full_name, 'email' => $email]);
    }
} else {
