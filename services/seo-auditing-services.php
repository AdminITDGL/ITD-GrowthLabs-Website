...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Quick Summary — SEO Audit & Optimization Services</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;"><strong>ITD GrowthLabs</strong> offers comprehensive <strong>SEO audit and optimization services</strong> including <strong>on-page SEO</strong>, <strong>technical SEO</strong>, <strong>local SEO</strong>, and <strong>content optimization</strong>. We help businesses in <strong>India, USA, UK, UAE, and Australia</strong> improve Google search rankings, fix technical issues, and drive sustainable organic traffic growth. <a href="../contact-us.php">Get a free SEO audit</a>.</p>
        </div>
    </div>
