...
<div class="container mt-5 mb-3">
    <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
        <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Quick Summary — iOS App Development Services</h3>
        <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;"><strong>ITD GrowthLabs</strong> provides expert <strong>iOS app development services</strong> using Swift and SwiftUI for <strong>iPhone and iPad apps</strong>. We build secure, scalable, App Store-ready applications for businesses across <strong>India, USA, UK, UAE, and Australia</strong>. <a href="../contact-us.php">Request a free iOS app consultation</a>.</p>
    </div>
</div>
