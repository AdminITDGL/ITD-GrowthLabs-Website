...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Quick Summary — Hybrid App Development Services</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;"><strong>ITD GrowthLabs</strong> offers <strong>hybrid app development services</strong> using <strong>Flutter, React Native, and Ionic</strong> to build <strong>cross-platform mobile apps</strong> that work seamlessly on both <strong>Android and iOS</strong>. Our hybrid apps reduce development cost by up to 40% while delivering native-like performance. Serving businesses across <strong>India, USA, UK, UAE & Australia</strong>. <a href="contact-us.php">Get a Free Consultation →</a></p>
        </div>
    </div>
