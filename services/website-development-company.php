...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Business Website Development</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">Your website should be your hardest-working employee — generating leads, building trust, and ranking on Google around the clock. We design and develop business websites that do exactly that, with clean code, fast load times, and conversion-focused design. <a href="../contact-us.php">Get a free website audit →</a></p>
        </div>
    </div>
