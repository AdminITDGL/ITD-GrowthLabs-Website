...
<head>
    ...
    <title>B2B Case Study Writing Services</title>
    ...
    <link rel="alternate" hreflang="en-in" href="https://itdgrowthlabs.com/services/case-study-writing-services.php" />
    <link rel="alternate" hreflang="en-us" href="https://itdgrowthlabs.com/services/case-study-writing-services.php" />
    <link rel="alternate" hreflang="en-gb" href="https://itdgrowthlabs.com/services/case-study-writing-services.php" />
    <link rel="alternate" hreflang="en-au" href="https://itdgrowthlabs.com/services/case-study-writing-services.php" />
    <link rel="alternate" hreflang="en-ae" href="https://itdgrowthlabs.com/services/case-study-writing-services.php" />
    <link rel="alternate" hreflang="x-default" href="https://itdgrowthlabs.com/services/case-study-writing-services.php" />
...
<body>
    ...
    <?php itdgl_render_modern_hero([
        'crumbs'  => [['label'=>'Home','url'=>'/'], ['label'=>'Digital Marketing','url'=>'/digital_marketing.php'], ['label'=>'Case Study Writing Services']],
        'eyebrow' => '<span class="pulse"></span>Senior-led delivery &middot; 300+ projects shipped',
        'pulse'   => true,
        'title'   => '<span class="accent">Case Study Writing Services</span> by ITD GrowthLabs.',
        'sub'     => 'Case study writing for businesses. Expertly written case studies to establish and reinforce your brand as an industry leader.',
        'primary' => ['url'=>'https://calendly.com/itdgrowthlabs-info/30min', 'label'=>'Book Free 30-min Call', 'icon'=>'fas fa-calendar-check', 'js_book_call'=>true, 'source'=>'service_case_study_writing_services_hero'],
    ...
    <section class="md-sec">
        <div class="container">
            ...
            <?php itdgl_render_outcome_grid([
                ['icon'=>'fas fa-user-tie', 'title'=>'Senior-led delivery', 'desc'=>'Every case study writing services engagement is led by a senior practitioner with 8&ndash;15 years in this category. No mid-level rotation, no junior hand-offs.'],
    ...
    <section class="md-sec">
        <div class="container">
            ...
            <?php itdgl_render_faq_accordion([
                'What does Case Study Writing Services cost in 2026?' => 'Pricing depends on scope, timeline and engagement model. We send a fixed-scope quote within 48 hours of a 30-minute discovery call. Most engagements in this category fall between &#8377;30K&ndash;&#8377;5L per month depending on scale; we&rsquo;ll quote yours after understanding specifics.',
                'How long does case study writing services usually take?' => 'Lightweight engagements: 2&ndash;6 weeks. Mid-sized: 2&ndash;4 months. Large multi-team programmes: 4&ndash;10 months. Most slippage comes from spec sign-off delays, not execution &mdash; we share weekly demos so anything slipping is visible early.',
    ...
    <section class="md-sec alt-warm">
        <div class="container">
            ...
            <?php itdgl_render_service_chips('case-study-writing-services'); ?>
        </div>
    </section>
    ...
    <?php itdgl_render_final_cta([
        ...
        'primary' => ['url'=>'https://calendly.com/itdgrowthlabs-info/30min', 'label'=>'Book a 30-min Call', 'icon'=>'fas fa-calendar-check', 'source'=>'service_case_study_writing_services_final'],
        'secondary'=>['url'=>'https://wa.me/918450978544?text=Hi%20ITD%20GrowthLabs%2C%20I%27d%20like%20to%20discuss%20a%20case study writing services%20project.', 'label'=>'WhatsApp Us', 'icon'=>'fab fa-whatsapp', 'target'=>'_blank'],
    ]); ?>
