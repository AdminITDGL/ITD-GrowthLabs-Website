                    ...
                    <div class="banner-style-three col-lg-7">
                        <div class="information">
                            ...
                            <div class="button mt-4 mb-5">
                                <a class="btn btn-theme btn-md animation" href="../contact-us.php" target="_blank">Build Your Website</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="tech-categories mb-50">
                <ul class="nav nav-pills justify-content-center gap-3 flex-wrap" id="techTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="design-tab" data-bs-toggle="pill" data-bs-target="#design" type="button" role="tab">Design</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="development-tab" data-bs-toggle="pill" data-bs-target="#development" type="button" role="tab">Development</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="techTabsContent">
                ...
                <div class="tab-pane fade" id="development" role="tabpanel">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="tech-stack-item">
                                <i class="fas fa-plug fa-3x mb-3" style="color: var(--color-primary);"></i>
                                <h5>Integration</h5>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-2">
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="tech-stack-item">
                                <i class="fas fa-code-branch fa-3x mb-3" style="color: var(--color-primary);"></i>
                                <h5>Versioning</h5>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion" id="faqAccordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        It involves building professional, scalable websites that represent your brand, showcase services, and support business growth with strong UI/UX and functionality.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        How do you align the website with our brand identity?
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        We understand your goals, values, and audience to design a website that reflects your brand consistently across design, content, and user experience.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        Are corporate websites scalable for future growth?
                                    </button>
                                </h2>
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we build scalable architectures and integrations, allowing your website to expand with new features, pages, and business needs over time.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                        Will the website support lead generation?
                                    </button>
                                </h2>
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we include optimized layouts, CTAs, and forms to capture leads and improve conversions for corporate businesses.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we offer continuous updates, security checks, and performance monitoring to ensure your website runs smoothly post-launch.
                                    </div>
                                </div>
                            </div>
                        </div>
