                    ...
                    <div class="banner-style-three col-lg-7">
                        <div class="information">
                            <h1 class="wow fadeInUp" data-wow-delay="500ms" data-wow-duration="400ms">
                                AI Marketing <span style="color: var(--color-primary);">Automation Services</span> for Smart Growth
                            </h1>
            ...
            <div class="tab-content" id="techTabsContent">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="tech-stack-item">
                                <i class="fas fa-lightbulb fa-3x mb-3" style="color: #0a66c2;"></i>
                ...
                <div class="tab-pane fade" id="backend" role="tabpanel">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="tech-stack-item">
                                <i class="fas fa-clipboard-check fa-3x mb-3" style="color: #34a853;"></i>
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="tech-stack-item">
                                <i class="fas fa-user-friends fa-3x mb-3" style="color: #34a853;"></i>
                ...
                <div class="tab-pane fade" id="databases" role="tabpanel">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="tech-stack-item">
                                <i class="fas fa-sync-alt fa-3x mb-3" style="color: #f4b400;"></i>
                ...
                <div class="tab-pane fade" id="cloud" role="tabpanel">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="tech-stack-item">
                                <i class="fas fa-chart-line fa-3x mb-3" style="color: #ea4335;"></i>
                ...
                <div class="tab-pane fade" id="analytics" role="tabpanel">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="tech-stack-item">
                                <i class="fas fa-rupee-sign fa-3x mb-3" style="color: #00a1f1;"></i>
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            <div class="tech-stack-item">
                                <i class="fas fa-user-check fa-3x mb-3" style="color: #00a1f1;"></i>
