...
<head>
    ...
    <meta property="og:title" content="Flutter App Development Services | Cross-Platform Apps | ITD GrowthLabs" />
    <meta property="og:description" content="Build cross-platform mobile apps with Flutter. ITD GrowthLabs delivers fast, beautiful Flutter apps for Android and iOS from a single codebase." />
    ...
    <link rel="alternate" hreflang="en-in" href="https://itdgrowthlabs.com/services/flutter_development.php" />
    <link rel="alternate" hreflang="en-us" href="https://itdgrowthlabs.com/services/flutter_development.php" />
    <link rel="alternate" hreflang="en-gb" href="https://itdgrowthlabs.com/services/flutter_development.php" />
    <link rel="alternate" hreflang="en-au" href="https://itdgrowthlabs.com/services/flutter_development.php" />
    <link rel="alternate" hreflang="en-ae" href="https://itdgrowthlabs.com/services/flutter_development.php" />
    <link rel="alternate" hreflang="x-default" href="https://itdgrowthlabs.com/services/flutter_development.php" />
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Service", "name": "Flutter Development", "description": "Build cross-platform mobile apps with Flutter. ITD GrowthLabs delivers fast, beautiful Flutter apps for Android and iOS from a single codebase.", "provider": {"@type": "Organization", "name": "ITD GrowthLabs", "url": "https://itdgrowthlabs.com", "logo": "https://itdgrowthlabs.com/assets/img/logo.jpg"}, "areaServed": ["India", "United States", "United Kingdom", "United Arab Emirates", "Australia", "Africa"], "offers": {"@type": "Offer", "availability": "https://schema.org/InStock", "url": "https://itdgrowthlabs.com/services/flutter_development.php"}}</script>
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 2, "name": "App & Software Development", "item": "https://itdgrowthlabs.com/app_development.php"}, {"@type": "ListItem", "position": 3, "name": "Flutter Development", "item": "https://itdgrowthlabs.com/services/flutter_development.php"}]}</script>
</head>
<body>
    ...
    <?php itdgl_render_modern_hero([
        'crumbs'  => [['label'=>'Home','url'=>'/'], ['label'=>'App &amp; Software Development','url'=>'/app_development.php'], ['label'=>'Flutter Development']],
        'eyebrow' => '<span class="pulse"></span>Senior-led delivery &middot; 300+ projects shipped',
        'pulse'   => true,
        'title'   => '<span class="accent">Flutter Development</span> by ITD GrowthLabs.',
        'sub'     => 'Build cross-platform mobile apps with Flutter. ITD GrowthLabs delivers fast, beautiful Flutter apps for Android and iOS from a single codebase.',
        'primary' => ['url'=>'https://calendly.com/itdgrowthlabs-info/30min', 'label'=>'Book Free 30-min Call', 'icon'=>'fas fa-calendar-check', 'js_book_call'=>true, 'source'=>'service_flutter_development_hero'],
    ...
    <section class="md-sec">
        <div class="container">
            ...
            <?php itdgl_render_outcome_grid([
                ['icon'=>'fas fa-user-tie', 'title'=>'Senior-led delivery', 'desc'=>'Every flutter development engagement is led by a senior practitioner with 8&ndash;15 years in this category. No mid-level rotation, no junior hand-offs.'],
    ...
    <section class="md-sec">
        <div class="container">
            ...
            <?php itdgl_render_faq_accordion([
                'What does Flutter Development cost in 2026?' => 'Pricing depends on scope, timeline and engagement model. We send a fixed-scope quote within 48 hours of a 30-minute discovery call. Most engagements in this category fall between &#8377;30K&ndash;&#8377;5L per month depending on scale; we&rsquo;ll quote yours after understanding specifics.',
                'How long does flutter development usually take?' => 'Lightweight engagements: 2&ndash;6 weeks. Mid-sized: 2&ndash;4 months. Large multi-team programmes: 4&ndash;10 months. Most slippage comes from spec sign-off delays, not execution &mdash; we share weekly demos so anything slipping is visible early.',
    ...
    <section class="md-sec alt-warm">
        <div class="container">
            ...
            <?php itdgl_render_service_chips('flutter_development'); ?>
        </div>
    </section>
    ...
    <?php itdgl_render_final_cta([
        ...
        'primary' => ['url'=>'https://calendly.com/itdgrowthlabs-info/30min', 'label'=>'Book a 30-min Call', 'icon'=>'fas fa-calendar-check', 'source'=>'service_flutter_development_final'],
        'secondary'=>['url'=>'https://wa.me/918450978544?text=Hi%20ITD%20GrowthLabs%2C%20I%27d%20like%20to%20discuss%20a%20flutter development%20project.', 'label'=>'WhatsApp Us', 'icon'=>'fab fa-whatsapp', 'target'=>'_blank'],
    ]); ?>
