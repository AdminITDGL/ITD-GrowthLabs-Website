                        ...
                        <div class="col-xl-6 col-lg-6 pr-50 pr-md-15 pr-xs-15 mt--80 mt-md-0 mt-xs-0">
                            <div class="information">
                                <h2 class="wow fadeInUp" data-wow-delay="500ms" data-wow-duration="400ms">
                                    <strong>Sell more, scroll less: Custom eCommerce websites built for speed, scale, and conversions.</strong>
                                </h2>
                                <p class="wow fadeInUp" data-wow-delay="900ms" data-wow-duration="400ms">
                                    Launch fully functional online stores with tailored UX, payment integrations, and backend controls—perfect for B2C, D2C, or multi-vendor models. </p>
                                <ul class="list-double mt-40">
                                    <li>Shopify, WooCommerce, and headless builds</li>
                                    <li>Custom catalog, checkout, and cart experiences</li>
                                    <li>Mobile-first storefronts with faster load times</li>
                                </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-5">
                    ...
                    <ul class="list-double mt-40">
                        <li>
                            <h5>Conversion-led UI</h5>
                            <p>Interfaces designed to nudge action, not just look good.</p>
                        </li>
                        <li>
                            <h5>Plugin Flexibility</h5>
                            <p>

                                Integrate loyalty, CRM, wallets, and automation tools. </p>
                        </li>
                        <li>
                            <h5>Fast Checkout</h5>

                            <p>
                                Reduce friction and bounce with simplified payment flows. </p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">Built for Merchants, Buyers, and Growth</h5>
                        <h2 class="title">Scalable eCommerce Solutions That Work Everywhere</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="feature-style-one">
                        <div class="info">
                            ...
                            <p>
                                Real-time inventory tracking, product variants, and automated stock syncing to avoid overselling or stockouts.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="feature-style-one">
                        <div class="info">
                            ...
                            <p>
                                SSL encryption, fraud detection layers, and customizable success/failure screens build user trust and ensure compliance.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="feature-style-one">
                        <div class="info">
                            ...
                            <p>
                                Powerful filtering and dynamic sorting by category, price, size, or popularity—ideal for growing catalogs.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="feature-style-one">
                        <div class="info">
                            ...
                            <p>
                                Get real-time insights into sales, revenue, user paths, cart abandonment, and returning customers—all in one place.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="feature-style-one">
                        <div class="info">
                            ...
                            <p>
                                Automatically sync buyer data to HubSpot, Zoho, or WhatsApp Business for remarketing, nurturing, and support.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="feature-style-one">
                        <div class="info">
                            ...
                            <p>
                                Enable seller registration, catalog control, commission tracking, and payouts via a unified admin interface.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1 about-style-three">
                    <div class="about-three-info">
                        <h4 class="sub-title mt-40">Optimized for Growth, Not Just Launch</h4>
                        <h2 class="title">Smart, Scalable eCommerce Platforms With Everything You Need</h2>

                        <ul class="list-grid-four">
                            <li><strong>Abandoned cart recovery and email workflows.</strong></li>
                            <li><strong>One-click checkout and wallet integration options.</strong></li>
                            <li><strong>Custom UI for categories, combos, and offers.</strong></li>
                            <li><strong>Real-time dashboard with advanced filtering.</strong></li>
                            <li><strong>Multi-language and multi-currency setup.</strong></li>
                            <li><strong>Scalability for 10 to 10,000+ SKUs.</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">How We Build Your Online Store</h2>
                    </div>
                </div>
            </div>
        </div>
