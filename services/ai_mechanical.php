...
<head>
    ...
    {"@context":"https://schema.org","@type":"Service","name":"AI Marketing Automation","description":"AI-driven marketing automation to automate campaigns and personalize customer journeys","provider":{"@type":"Organization","name":"ITD GrowthLabs","url":"https://itdgrowthlabs.com"},"areaServed":["India","Australia","UAE","UK","USA"],"serviceType":"AI Automation"}
    </script>

    <script type="application/ld+json">
    {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 2, "name": "Services", "item": "https://itdgrowthlabs.com/app_development.php"}, {"@type": "ListItem", "position": 3, "name": "AI Marketing Automation Services"}]}
    </script>
                    ...
                    <div class="banner-style-three col-lg-7">
                        <div class="information">
                            <h1 class="wow fadeInUp" data-wow-delay="500ms" data-wow-duration="400ms">
                                AI Marketing <span style="color: var(--color-primary);">Automation</span> Services for Smart Growth AI
                            </h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="fun-fact text-center">
                        ...
                        <h4>Automation Projects Delivered</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="fun-fact text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="tech-stack-item">
                        ...
                        <h5>AI Automation Platforms</h5>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="tech-stack-item">
                        <i class="fas fa-link fa-3x mb-3" style="color: #0a66c2;"></i>
                        <h5>CRM Integration</h5>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="tech-stack-item">
                        <i class="fas fa-envelope fa-3x mb-3" style="color: #0a66c2;"></i>
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="tech-stack-item">
                        <i class="fas fa-share-alt fa-3x mb-3" style="color: #0a66c2;"></i>
                        <h5>Multi-Channel Tools</h5>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="tech-stack-item">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="tech-stack-item">
                        <i class="fas fa-bullseye fa-3x mb-3" style="color: #34a853;"></i>
                        ...
                        <div class="accordion" id="faqAccordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        AI marketing automation uses artificial intelligence to automate and optimize marketing campaigns, personalize customer journeys, manage leads, and improve engagement. It combines smart workflows with data-driven insights to deliver faster execution and better results.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        How does AI-driven marketing automation improve campaign performance?
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        AI-driven marketing automation helps streamline campaign planning, automate lead nurturing, personalize messaging based on audience segments, and provide real-time analytics. This improves efficiency, increases conversion rates, and delivers measurable marketing outcomes.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        Can you integrate AI marketing automation with our existing CRM?
                                    </button>
                                </h2>
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes. We integrate AI marketing automation with popular CRMs and marketing tools to centralize data, automate workflows, and improve campaign efficiency. Our solutions work across email, social, and web platforms for consistent engagement.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Timeline depends on scope—campaign setup, system configuration, audience mapping, and platform integration. We provide clear timelines upfront and follow a structured process from discovery and design to deployment and ongoing support.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFive">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        Do you offer ongoing AI marketing automation support?
                                    </button>
                                </h2>
                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Absolutely. We offer continuous support with campaign updates, performance optimization, scaling, and strategy enhancements. Our team helps you maximize ROI through regular analytics review and AI-driven marketing automation improvements.
                                    </div>
                                </div>
                            </div>
                        </div>
