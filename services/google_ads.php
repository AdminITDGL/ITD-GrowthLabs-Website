...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Expert Google Ads PPC management services to drive traffic, leads, and sales.",
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "FAQPage",
        "mainEntity": [
            {"@type": "Question", "name": "How much should I budget for Google Ads?", "acceptedAnswer": {"@type": "Answer", "text": "Google Ads budgets depend on your industry, competition, and goals. Most small businesses start with $500-$2,000/month in ad spend plus management fees. High-competition industries like legal or finance may require $3,000-$10,000+/month. We optimize campaigns to maximize ROI regardless of budget size."}},
            {"@type": "Question", "name": "How quickly can Google Ads generate leads?", "acceptedAnswer": {"@type": "Answer", "text": "Google Ads can start generating leads within 24-48 hours of campaign launch. However, optimal performance typically takes 2-4 weeks of data collection and optimization. We continuously refine targeting, bidding, and ad copy to improve cost per lead over time."}},
            {"@type": "Question", "name": "What types of Google Ads campaigns do you manage?", "acceptedAnswer": {"@type": "Answer", "text": "We manage Search Ads, Display Ads, Shopping Ads, YouTube/Video Ads, Performance Max campaigns, and Remarketing campaigns. Our certified Google Ads specialists choose the right campaign mix based on your business objectives, whether that's lead generation, brand awareness, or e-commerce sales."}},
            {"@type": "Question", "name": "How do you optimize Google Ads campaigns?", "acceptedAnswer": {"@type": "Answer", "text": "We optimize through keyword refinement, negative keyword management, ad copy A/B testing, landing page optimization, bid strategy adjustment, audience targeting, device/location bid modifiers, and conversion tracking. We review and optimize campaigns weekly to ensure maximum ROI."}}
        ]
    }
    </script>

    <script type="application/ld+json">
    {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 2, "name": "Services", "item": "https://itdgrowthlabs.com/app_development.php"}, {"@type": "ListItem", "position": 3, "name": "Google Ads PPC Management Services"}]}
    </script>
</head>
...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Google Ads Management</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">We manage Google Ads campaigns that bring in qualified leads at the lowest possible cost per acquisition. Search ads, display, shopping, YouTube — we handle the strategy, bidding, copywriting, and continuous optimization. Most clients see results within the first 30 days. <a href="../contact-us.php">Get a free PPC consultation →</a></p>
        </div>
    </div>
