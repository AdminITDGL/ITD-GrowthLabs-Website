...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Quick Summary — Google Ads & PPC Management Services</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;"><strong>ITD GrowthLabs</strong> offers professional <strong>Google Ads management</strong> and <strong>PPC advertising services</strong> including Search Ads, Display Ads, Shopping Ads, and Remarketing campaigns. We help B2B businesses across <strong>India, USA, UK, UAE, and Australia</strong> generate high-quality leads and maximize return on ad spend. <a href="../contact-us.php">Get a free PPC audit</a>.</p>
        </div>
    </div>
