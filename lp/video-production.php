...
<head>
    ...
    <meta name="description" content="Get high-quality product and ad videos with ITD GrowthLabs. We create professional product videos, reels, real estate shoots, and corporate films to boost your brand.">
    <title>Video Production Services | Product, Ad & Real Estate Videos | ITD GrowthLabs</title>
    ...
    <!-- SEO Optimization -->
    <link rel="canonical" href="https://itdgrowthlabs.com/lp/video-production.php" />
    <meta property="og:title" content="Video Production Services | Product, Ad & Real Estate Videos | ITD GrowthLabs" />
    <meta property="og:description" content="Get high-quality product and ad videos with ITD GrowthLabs. We create professional product videos, reels, real estate shoots, and corporate films to boost your brand." />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://itdgrowthlabs.com/lp/video-production.php" />
    <meta property="og:image" content="https://itdgrowthlabs.com/assets/img/logo.jpg" />
    <script type="application/ld+json">
    {"@context":"https://schema.org","@type":"Service","name":"Video Production Services | Product, Ad & Real Estate Videos","description":"Get high-quality product and ad videos with ITD GrowthLabs. We create professional product videos, reels, real estate shoots, and corporate films to b","provider":{"@type":"Organization","name":"ITD GrowthLabs","url":"https://itdgrowthlabs.com"},"areaServed":["India","Australia","UAE","UK","USA"],"serviceType":"Video Production"}
    </script>
</head>
                    ...
                    <div class="banner-style-three col-lg-6">
                        <div class="information">
                            <h2 class="wow fadeInUp" data-wow-delay="500ms" data-wow-duration="400ms">
                                <strong>Professional Product & Ad Videos That Drive Sales</strong>
                            </h2>
                            <p class="wow fadeInUp" data-wow-delay="900ms" data-wow-duration="400ms">
                                From product videos to ad shoots and real estate walkthroughs — we create high-quality, conversion-focused videos that tell your brand story.
                            </p>
                            ...
                            <div class="button mt-4 mb-5">
                                <a class="btn btn-theme btn-md animation" href="../contact-us.php">Schedule A Video Consultation</a>
                            </div>
                            <div class="row text-center g-4 icon_circle_block">
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #ff5722; color: #fff;">
                                        <i class="fas fa-video fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Promotional</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #673ab7; color: #fff;">
                                        <i class="fas fa-film fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Explainer</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #009688; color: #fff;">
                                        <i class="fas fa-photo-video fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Motion Graphics</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #3b5998; color: #fff;">
                                        <i class="fas fa-mobile-alt fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Social Media</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #607d8b; color: #fff;">
                                        <i class="fas fa-building fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Corporate</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="default-padding box-layout overflow-hidden bottom-less services-style-one-area bg-gray bg-cover" style="background-image: url(../assets/img/shape/banner-2.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">Create Impact With Powerful Visuals</h5>
                        <h2 class="title">Professional Video Production for Ads, Products & Real Estate</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row" style="display: flex; flex-wrap: wrap;">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Showcase your product’s features with cinematic visuals.</p>
                        <h4><a href="#">Product Videos</a></h4>
                    </div>
                </div>

                <!-- Feature 2: Ad Videos & Reels -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Short, engaging videos perfect for social media ads and brand awareness.</p>
                        <h4><a href="#">Ad Videos & Reels</a></h4>
                    </div>
                </div>

                <!-- Feature 3: Factory & Corporate Shoots -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Professional video coverage for manufacturing units, plants, or offices.</p>
                        <h4><a href="#">Factory & Corporate Shoots</a></h4>
                    </div>
                </div>

                <!-- Feature 4: Real Estate Walkthroughs -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Virtual property tours to attract potential buyers and investors.</p>
                        <h4><a href="#">Real Estate Walkthroughs</a></h4>
                    </div>
                </div>

                <!-- Feature 5: Script-to-Screen Production -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>We handle concept, script, shoot, and post-production end-to-end.</p>
                        <h4><a href="#">Script-to-Screen Production</a></h4>
                    </div>
                </div>

                <!-- Feature 6: High-Quality Editing & Effects -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Color grading, voiceovers, and motion graphics for a professional finish.</p>
                        <h4><a href="#">High-Quality Editing & Effects</a></h4>
                    </div>
                </div>
                        ...
                        <div class="accordion" id="faqAccordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        We specialize in product videos, ad reels, corporate videos, and real estate walkthroughs.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        Do you handle the entire production process?
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, from ideation and scriptwriting to shooting and editing.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, our team travels to client locations across India for on-site shoots.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                        How long does video delivery take?
                                    </button>
                                </h2>
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Typically 7–14 days depending on the project scope and revisions.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFive">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        What’s the starting cost for a video project?
                                    </button>
                                </h2>
                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Basic video shoots start around ₹10,000, and prices vary by duration and complexity.
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const form = document.getElementById("videoProductionForm");
            form.addEventListener("submit", function(e) {
                e.preventDefault();
                grecaptcha.ready(function() {
                    grecaptcha.execute('6Lcm0hosAAAAAPFeuKRDfgGF4Ajr9bcCCbD7LR-3', {
                        action: 'video_production_form'
                    }).then(function(token) {
