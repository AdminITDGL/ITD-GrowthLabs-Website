...
<body>
                    ...
                    <div class="banner-style-three col-lg-6">
                        <div class="information">
                            ...
                            <div class="button mt-4 mb-5">
                                <a class="btn btn-theme btn-md animation" href="https://wa.me/918450978544?text=Hi%2C%20I%20want%20to%20schedule%20a%20video%20production%20consultation." target="_blank">Schedule A Video Consultation</a>
                            </div>
                    ...
                    <div class="col-tact-stye-one col-lg-5 offset-lg-1">
                        <div class="contact-form-style-one">
                            ...
                            <div class="col-lg-12 alert-notification">
                                <div id="showMessage_vp" class="alert-msg"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $('#videoProductionForm').on('submit', function(e) {
            e.preventDefault();
            const $showMessage = $('#showMessage_vp').show().html('<i class="fas fa-spinner fa-spin"></i> Sending...');
            const formData = new FormData(this);
            const showMessage = (msg, showMessage) => {
                $showMessage.removeClass().addClass(showMessage).html(msg).show();
            };
            $.ajax({
                url: '../videoProductionFormMail.php',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
