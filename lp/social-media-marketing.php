...
<head>
    ...
    <meta name="description" content="Grow your brand online with ITD GrowthLabs. We manage Facebook, Instagram & LinkedIn to increase engagement, reach, and conversions.">
    <title>Social Media Marketing Services | Facebook, Instagram & LinkedIn | ITD GrowthLabs</title>
    ...
    <!-- SEO Optimization -->
    <link rel="canonical" href="https://itdgrowthlabs.com/lp/social-media-marketing.php" />
    <meta property="og:title" content="Social Media Marketing Services | Facebook, Instagram & LinkedIn | ITD GrowthLabs" />
    <meta property="og:description" content="Grow your brand online with ITD GrowthLabs. We manage Facebook, Instagram & LinkedIn to increase engagement, reach, and conversions." />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://itdgrowthlabs.com/lp/social-media-marketing.php" />
    <meta property="og:image" content="https://itdgrowthlabs.com/assets/img/logo.jpg" />
    <script type="application/ld+json">
    {"@context":"https://schema.org","@type":"Service","name":"Social Media Marketing Services | Facebook, Instagram & LinkedIn","description":"Grow your brand online with ITD GrowthLabs. We manage Facebook, Instagram & LinkedIn to increase engagement, reach, and conversions.","provider":{"@type":"Organization","name":"ITD GrowthLabs","url":"https://itdgrowthlabs.com"},"areaServed":["India","Australia","UAE","UK","USA"],"serviceType":"Digital Services"}
    </script>
</head>
                        ...
                        <div class="information">
                            ...
                            <div class="row text-center g-4 icon_circle_block">
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #1877F2; color: #fff;">
                                        <i class="fab fa-facebook-f fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Facebook Marketing</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background: radial-gradient(circle at 30% 107%, #fdf497 0%, #fd5949 45%, #d6249f 60%, #285AEB 90%); color: #fff;">
                                        <i class="fab fa-instagram fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Instagram Marketing</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #25D366; color: #fff;">
                                        <i class="fab fa-whatsapp fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">WhatsApp Marketing</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #0A66C2; color: #fff;">
                                        <i class="fab fa-linkedin-in fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">LinkedIn Marketing</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-content p-3">
                                <div class="information">
                                    <h4 class="wow fadeInUp mb-30 text-center" data-wow-delay="500ms" data-wow-duration="400ms">
                                        <b>Get a Free Social Media Strategy Call</b>
                                    </h4>
                                </div>
                                <form id="socialMediaForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <select name="preferred_platform" class="form-control" required>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <textarea name="message" class="form-control" rows="4" placeholder="Message / Business Goal *" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
    ...
    <div class="default-padding box-layout overflow-hidden bottom-less services-style-one-area bg-gray bg-cover" style="background-image: url(../assets/img/shape/banner-2.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">Your Brand, Our Strategy</h5>
                        <h2 class="title">End-to-End Social Media Management That Drives Engagement</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row" style="display: flex; flex-wrap: wrap;">
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>We plan, design, post, and manage your brand pages on Facebook, Instagram & LinkedIn.</p>
                        <h4><a href="#">Full Social Media Management</a></h4>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>We enhance your business profiles for better discoverability and professionalism.</p>
                        <h4><a href="#">Profile Optimization</a></h4>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Get visually engaging posts, reels, and banners tailored to your brand voice.</p>
                        <h4><a href="#">Creative Content Design</a></h4>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Run high-performing paid ads to boost followers, engagement, and leads.</p>
                        <h4><a href="#">Ad Campaign Management</a></h4>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Transparent analytics showing growth in reach, engagement, and conversions.</p>
                        <h4><a href="#">Monthly Reports & Insights</a></h4>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>One point of contact for all your campaign needs.</p>
                        <h4><a href="#">Dedicated Account Manager</a></h4>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="accordion" id="faqAccordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        We manage Facebook, Instagram, and LinkedIn, with plans to include YouTube and Twitter (X) on request.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        Do you provide content and post designs?
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, our in-house team creates and schedules content calendars, captions, and graphics.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Absolutely. We manage ad budgets, targeting, and optimization to generate maximum ROI.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                        What’s the minimum duration for SMM services?
                                    </button>
                                </h2>
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        We recommend at least a 3-month campaign to see visible results in engagement and leads.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        You’ll receive a monthly performance report with metrics like reach, engagement, and follower growth.
                                    </div>
                                </div>
                            </div>
