...
<head>
    ...
    <meta name="description" content="Generate high-quality leads with ITD GrowthLabs. We specialize in performance marketing via Google Ads, Facebook, and Instagram to help businesses grow.">
    <title>Lead Generation Services | Google & Meta Ads Campaigns | ITD GrowthLabs</title>
    ...
    <!-- SEO Optimization -->
    <link rel="canonical" href="https://itdgrowthlabs.com/lp/lead-generation-services.php" />
    <meta property="og:title" content="Lead Generation Services | Google & Meta Ads Campaigns | ITD GrowthLabs" />
    <meta property="og:description" content="Generate high-quality leads with ITD GrowthLabs. We specialize in performance marketing via Google Ads, Facebook, and Instagram to help businesses grow." />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://itdgrowthlabs.com/lp/lead-generation-services.php" />
    <meta property="og:image" content="https://itdgrowthlabs.com/assets/img/logo.jpg" />
    <script type="application/ld+json">
    {"@context":"https://schema.org","@type":"Service","name":"Lead Generation Services | Google & Meta Ads Campaigns","description":"Generate high-quality leads with ITD GrowthLabs. We specialize in performance marketing via Google Ads, Facebook, and Instagram to help businesses gro","provider":{"@type":"Organization","name":"ITD GrowthLabs","url":"https://itdgrowthlabs.com"},"areaServed":["India","Australia","UAE","UK","USA"],"serviceType":"Digital Services"}
    </script>
</head>
                    ...
                    <div class="banner-style-three col-lg-6">
                        <div class="information">
                            <h2 class="wow fadeInUp" data-wow-delay="500ms" data-wow-duration="400ms">
                                <strong>Get Qualified Leads for Your Business</strong>
                            </h2>
                            <p class="wow fadeInUp" data-wow-delay="900ms" data-wow-duration="400ms">
                                We help you generate quality leads through performance marketing — using Google Ads, Meta Ads (Facebook & Instagram), and optimized landing pages.
                            </p>
                            ...
                            <div class="button mt-4 mb-5">
                                <a class="btn btn-theme btn-md animation" href="../contact-us.php">Ask About Services</a>
                            </div>
                            <div class="row text-center g-4 icon_circle_block">
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #4285F4; color: #fff;">
                                        <i class="fab fa-google fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Google Ads</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #0078FF; color: #fff;">
                                        <i class="fab fa-facebook-messenger fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Meta Ads</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    ...
                                    <p class="mb-0 fw-semibold">LinkedIn Outreach</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #D44638; color: #fff;">
                                        <i class="fas fa-envelope fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Email Campaigns</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="default-padding box-layout overflow-hidden bottom-less services-style-one-area bg-gray bg-cover" style="background-image: url(../assets/img/shape/banner-2.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">Maximize ROI With Smart Ad Campaigns</h5>
                        <h2 class="title">Targeted Google & Meta Ads for Real Business Results</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row" style="display: flex; flex-wrap: wrap;">
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>ROI-focused strategies using Google Ads & Meta Ads.</p>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>We target by interests, demographics, and buying intent.</p>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Designed for conversions and mobile performance.</p>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Get detailed reports with form submissions and cost per lead.</p>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Tailored campaigns for both business and consumer audiences.</p>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>100% clarity on ad spend and performance results.</p>
                        ...
                        <div class="accordion" id="faqAccordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        We run targeted Google Ads, Meta Ads, and retargeting campaigns that drive traffic to optimized landing pages with lead forms.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        Do you handle ad creatives and copy?
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, our team creates the ad visuals, copy, and landing page content.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, you’ll receive real-time data via Google Sheets or CRM integration.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        We’ve worked with clients in logistics, real estate, manufacturing, eCommerce, and tech.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFive">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        How soon can I expect leads?
                                    </button>
                                </h2>
                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Campaigns typically start generating leads within 5–10 days of launch.
                                    </div>
                                </div>
                            </div>
