...
<head>
    ...
    <meta name="description" content="Get professional website design and development services with ITD GrowthLabs. We build fast, responsive, SEO-optimized websites in WordPress, PHP, React, and more.">
    <title>Website Design & Development Services | ITD GrowthLabs</title>
...
<body>
                        ...
                        <div class="information">
                            ...
                            <div class="row text-center g-4 icon_circle_block">
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #21759b; color: #fff;">
                                        <i class="fab fa-wordpress fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">WordPress</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #ff6f61; color: #fff;">
                                        <i class="fas fa-paint-brush fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Custom Design</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #0070ba; color: #fff;">
                                        <i class="fas fa-shopping-cart fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">eCommerce</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #777bb3; color: #fff;">
                                        <i class="fab fa-php fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">PHP</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #ff9900; color: #fff;">
                                        <i class="fas fa-search fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">SEO</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-4 d-flex flex-column align-items-center">
                                    <div class="icon_circle rounded-circle d-flex justify-content-center align-items-center mb-3" style="background-color: #00aaff; color: #fff;">
                                        <i class="fas fa-laptop-code fa-2x"></i>
                                    </div>
                                    <p class="mb-0 fw-semibold">Web Apps</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-tact-stye-one col-lg-5 offset-lg-1">
                        <div class="contact-form-style-one bg-white p-5">
                            <div class="information">
                                <h4 class="wow fadeInUp mb-30 text-center" data-wow-delay="500ms" data-wow-duration="400ms">
                                    <b>Get Your Free Website Consultation</b>
                                </h4>
                            </div>
                            <form id="websiteDesignForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <button type="submit" class="btn btn-primary">Get Free Quote Now</button>
                                    </div>
                                </div>
                                <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-wdd">
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div class="default-padding bg-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5 class="sub-title">Complete In-House Website Solutions</h5>
                        <h2 class="title">From Concept to Code — We Build High-Performance Websites</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row" style="display: flex; flex-wrap: wrap;">
                <!-- Feature 1: End-to-End Development -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>From planning and UI/UX design to full-stack development — all done in-house.</p>
                        <h4><a href="#">End-to-End Development</a></h4>
                    </div>
                </div>

                <!-- Feature 2: Multi-Platform Expertise -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>We develop websites in WordPress, PHP, React, HTML/CSS, Ruby & Ruby on Rails.</p>
                        <h4><a href="#">Multi-Platform Expertise</a></h4>
                    </div>
                </div>

                <!-- Feature 3: SEO & Speed Optimized -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Every page is designed to rank faster and load quickly.</p>
                        <h4><a href="#">SEO & Speed Optimized</a></h4>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <h4><a href="#">Mobile-Responsive Design</a></h4>
                    </div>
                </div>

                <!-- Feature 5: Maintenance & Support -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>We provide annual maintenance and content updates to keep your website running smoothly.</p>
                        <h4><a href="#">Maintenance & Support</a></h4>
                    </div>
                </div>

                <!-- Feature 6: Affordable Packages -->
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="services-style-one">
                        ...
                        <p>Tailored plans for startups, SMBs, and growing businesses.</p>
                        <h4><a href="#">Affordable Packages</a></h4>
                    </div>
                </div>
                        ...
                        <div class="accordion" id="faqAccordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Most websites are completed within 2–4 weeks depending on the complexity, features, and content availability.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        A basic website starts around ₹15,000, while eCommerce or custom builds can vary based on features.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we offer hosting, domain registration, and maintenance services as add-ons.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Absolutely. We follow on-page SEO best practices, optimize metadata, and ensure your site is search-friendly.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we can revamp outdated designs with a modern look and improved functionality.
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const form = document.getElementById("websiteDesignForm");
            form.addEventListener("submit", function(e) {
                e.preventDefault();
                grecaptcha.ready(function() {
                    grecaptcha.execute('6Lcm0hosAAAAAPFeuKRDfgGF4Ajr9bcCCbD7LR-3', {
                        action: 'website_design_form'
                    }).then(function(token) {
                        document.getElementById('g-recaptcha-response-wdd').value = token;

                         const formData = new FormData(form);
                         fetch("../websiteDesignFormMail.php", {
                                 method: "POST",
                                 body: formData,
                             })
                             .then((res) => res.json())
