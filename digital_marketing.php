        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-6 col-md-3 mb-2 mb-md-0">
                    ...
                    <div style="font-size: 13px; color: #5f6368; font-weight: 500;">Campaigns Managed</div>
                </div>
                <div class="col-6 col-md-3 mb-2 mb-md-0">
                    <div style="font-size: 28px; font-weight: 800; color: var(--color-primary);">3x</div>
                    <div style="font-size: 13px; color: #5f6368; font-weight: 500;">Avg. Traffic Growth</div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">Trusted Digital Marketing Company in India</h2>
                        <p class="mt-30">
                            ITD GrowthLabs is a leading digital marketing company helping startups, SMEs, and enterprises grow online. From SEO and social media marketing to PPC and content strategies, we turn your plans into measurable business growth.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row" style="display: flex; flex-wrap: wrap;">
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Targeted campaigns on Facebook, Instagram, and LinkedIn to boost engagement and brand awareness.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>High-converting campaigns on Google Ads, Bing, and social platforms to drive instant traffic and leads.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Blogs, articles, videos, and infographics that attract, educate, and convert audiences.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Personalized campaigns, newsletters, and automation to improve engagement and retention.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Collaborations with influencers to build credibility, reach new audiences, and drive sales.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Performance-based campaigns and partnerships to expand reach and increase revenue.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); padding: 40px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3 style="color: #fff; margin: 0; font-size: 24px;">Want to 3x Your Organic Traffic &amp; Reduce Cost Per Lead?</h3>
                    <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0; font-size: 16px;">Schedule a free 30-minute strategy call with our digital marketing experts.</p>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <p class="mt-30">We use modern and proven digital marketing strategies to deliver measurable results, increased traffic, and brand growth — designed to scale your business.</p>
                    </div>
                </div>
            </div>
