...
<head>
    ...
    <link rel="alternate" hreflang="en-gb" href="https://itdgrowthlabs.com/contact-us.php" />
    <link rel="alternate" hreflang="en-au" href="https://itdgrowthlabs.com/contact-us.php" />
    ...
    <style>
        ...
        .ct-form-wrap .btn-primary:hover { background: var(--md-primary-dark); transform: translateY(-1px); box-shadow: 0 10px 26px rgba(30,64,175,0.38); }
