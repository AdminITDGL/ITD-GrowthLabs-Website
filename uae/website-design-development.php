                    ...
                    <div class="banner-style-three col-lg-7">
                        <div class="information">
                            <h2 class="wow fadeInUp" data-wow-delay="500ms" data-wow-duration="400ms">
                                Professional Website Design &amp; Development Company in UAE
                            </h2>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">WHY CHOOSE ITD GROWTHLABS FOR WEBSITE DEVELOPMENT IN UAE</h2>
                    </div>
                </div>
            </div>
            <div class="row mt-40">
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <h4>UAE-Focused Digital Expertise</h4>
                        <p>We understand the UAE business ecosystem—from corporate branding standards to customer behavior and multilingual requirements. Our websites are designed to appeal to both local and international audiences.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        <div class="icon-wrapper"><i class="fas fa-paint-brush"></i></div>
                        <h4>Custom-Built, Not Templates</h4>
                        <p>No cookie-cutter designs. Every website is custom-designed to match your brand identity, business goals, and industry requirements.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        <div class="icon-wrapper"><i class="fas fa-search"></i></div>
                        <h4>SEO-First Development Approach</h4>
                        <p>Unlike typical web agencies, we build websites with SEO architecture baked in, helping you rank on Google for UAE-based searches.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Our websites are built to grow with your business—easy to update, expand, and integrate with third-party tools.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">OUR WEBSITE DESIGN &amp; DEVELOPMENT SERVICES IN UAE</h2>
                    </div>
                </div>
            </div>
            <div class="row mt-40">
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>We create visually stunning, brand-aligned designs that establish credibility and trust among UAE audiences.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Robust backend development using modern technologies to ensure speed, security, and scalability.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>With most UAE users browsing on mobile, we design websites that perform seamlessly across all devices.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>We structure your website to rank on Google from day one.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Professional websites for UAE corporates, logistics firms, real estate companies, and service businesses.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Upgrade outdated websites with modern UI, improved UX, and better performance.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">OUR WEBSITE DEVELOPMENT PROCESS (UAE PROJECTS)</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="process-row">
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <h5>Strategy</h5>
                            <p>We understand your business goals and competitors in the UAE market.</p>
                        </div>
                    </div>
                    ...
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <h5>UI/UX</h5>
                            <p>Wireframes and design concepts tailored to your brand journey.</p>
                        </div>
                    </div>
                    <div class="process-connector"><i class="fas fa-arrow-right"></i></div>
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <h5>Development</h5>
                            <p>Clean, secure, and scalable development following best practices.</p>
                        </div>
                    </div>
                    <div class="process-connector"><i class="fas fa-arrow-right"></i></div>
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <h5>Testing </h5>
                            <p>Performance testing, browser compatibility checks validation.</p>
                        </div>
                    </div>
                    <div class="process-connector"><i class="fas fa-arrow-right"></i></div>
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <h5>Launch </h5>
                            <p>Smooth deployment with support and maintenance options.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="industry-card">
                                ...
                                <div class="industry-overlay">
                                    ...
                                    <span>Real Estate &amp; Property Developers</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="industry-card">
                                ...
                                <div class="industry-overlay">
                                    ...
                                    <span>Logistics &amp; Supply Chain Companies</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="industry-card">
                                ...
                                <div class="industry-overlay">
                                    ...
                                    <span>Education &amp; Training Institutes</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 mb-30">
                            <div class="why-choose-card">
                                ...
                                <h4>Experienced web designers &amp; developers</h4>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-30">
                            <div class="why-choose-card">
                        ...
                        <div class="col-md-6 col-lg-4 mb-30">
                            <div class="why-choose-card">
                                ...
                                <h4>Long-term support &amp; scalability</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center text-light mt-0 mb-0">
                        <h2 class="title text-white mb-30">Ready to Build a High-Performance Website in UAE?</h2>
                        ...
                        <div class="button mt-40">
                            <a class="btn btn-theme btn-md animation" href="https://calendly.com/itdgrowthlabs-info/30min" target="_blank">Talk to a UAE Web Expert</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">FAQ – WEBSITE DESIGN &amp; DEVELOPMENT IN UAE</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                        1. How much does website design cost in UAE?
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Website costs depend on features, design complexity, and integrations. Basic business websites start lower, while custom enterprise solutions cost more. We provide transparent, tailored quotes.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        2. How long does it take to develop a website in UAE?
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        A standard business website takes 4–6 weeks, while complex or custom websites may take 8–12 weeks.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        3. Do you provide SEO with website development?
                                    </button>
                                </h2>
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes. All our websites include SEO-friendly architecture, and we also offer ongoing SEO services for UAE businesses.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                        4. Can you create Arabic or bilingual websites?
                                    </button>
                                </h2>
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Absolutely. We develop Arabic, English, and bilingual websites, including RTL layout support.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingSix">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                        6. Do you provide website maintenance after launch?
                                    </button>
                                </h2>
                                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes. We offer website maintenance, updates, security monitoring, and performance optimization services.
                                    </div>
                                </div>
                            </div>
                        </div>
