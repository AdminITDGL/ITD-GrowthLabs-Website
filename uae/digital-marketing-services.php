                    ...
                    <div class="banner-style-three col-lg-7">
                        <div class="information">
                            <h2 class="wow fadeInUp" data-wow-delay="500ms" data-wow-duration="400ms">
                                Result-Driven Digital Marketing Services in UAE
                            </h2>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">WHY CHOOSE ITD GROWTHLABS AS YOUR DIGITAL MARKETING COMPANY IN UAE</h2>
                    </div>
                </div>
            </div>
            <div class="row mt-40">
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <h4>UAE Market Understanding</h4>
                        <p>We design campaigns based on UAE customer behavior, competition, and search intent—not generic global strategies.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Every campaign is built around KPIs like leads, conversions, and ROI.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>SEO, paid ads, social media, content, and lead generation—all under one roof.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Clear dashboards, regular updates, and performance insights you can actually understand.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">OUR DIGITAL MARKETING SERVICES IN UAE</h2>
                    </div>
                </div>
            </div>
            <div class="row mt-40">
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Rank higher on Google and attract high-intent organic traffic from UAE searches.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        <div class="icon-wrapper"><i class="fab fa-google"></i></div>
                        <h4>2. Google Ads &amp; Performance Marketing</h4>
                        <p>Instant visibility and qualified leads through high-converting paid campaigns.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Build brand awareness, engagement, and leads on platforms your audience uses.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        <div class="icon-wrapper"><i class="fas fa-bullseye"></i></div>
                        <h4>4. Lead Generation Campaigns</h4>
                        <p>We design campaigns specifically focused on business enquiries and sales leads.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        <div class="icon-wrapper"><i class="fas fa-chart-line"></i></div>
                        <h4>5. Website &amp; Funnel Optimization</h4>
                        <p>We optimize your website and landing pages to improve conversions from paid and organic traffic.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        <div class="icon-wrapper"><i class="fas fa-chart-bar"></i></div>
                        <h4>6. Marketing Analytics &amp; Reporting</h4>
                        <p>Data-driven decisions powered by real performance metrics.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">OUR DIGITAL MARKETING PROCESS (UAE)</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="process-row">
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <p>Understanding your goals, audience, competitors, and market positioning in UAE.</p>
                        </div>
                    </div>
                    ...
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <h5>Strategy &amp; Channel Planning</h5>
                            <p>Selecting the right channels—SEO, ads, social, or lead gen—based on ROI potential.</p>
                        </div>
                    </div>
                    <div class="process-connector"><i class="fas fa-arrow-right"></i></div>
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <p>Launching and optimizing campaigns with continuous performance monitoring.</p>
                        </div>
                    </div>
                    <div class="process-connector"><i class="fas fa-arrow-right"></i></div>
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <p>Improving performance, reducing costs, and scaling winning campaigns.</p>
                        </div>
                    </div>
                    <div class="process-connector"><i class="fas fa-arrow-right"></i></div>
                    <div class="process-hexagon">
                        <div class="hexagon-content">
                            ...
                            <h5>Reporting &amp; Growth Planning</h5>
                            <p>Monthly reports with actionable insights and next-step recommendations.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 mb-30">
                            <div class="why-choose-card">
                                ...
                                <h4>Proven digital marketing expertise</h4>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-30">
                            <div class="why-choose-card">
                                <div class="icon-wrapper"><i class="fas fa-industry"></i></div>
                                <h4>Industry-specific strategies</h4>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-30">
                            <div class="why-choose-card">
                                <div class="icon-wrapper"><i class="fas fa-chart-bar"></i></div>
                                <h4>Transparent pricing &amp; reporting</h4>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-30">
                            <div class="why-choose-card">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center text-light mt-0 mb-0">
                        <h2 class="title text-white mb-30">Ready to Grow Your Business with Digital Marketing in UAE?</h2>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">FAQ – DIGITAL MARKETING SERVICES IN UAE</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                        1. How much do digital marketing services cost in UAE?
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Pricing depends on channels, scope, and campaign goals. We offer flexible monthly packages based on your requirements.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Paid ads: 2–4 weeks<br>SEO: 3–6 months for sustainable results
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        3. Do you provide SEO and paid ads together?
                                    </button>
                                </h2>
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes. We offer integrated digital marketing packages combining SEO, PPC, and social media.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                        4. Can you generate B2B leads in UAE?
                                    </button>
                                </h2>
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Absolutely. We specialize in lead generation campaigns for B2B and service-based businesses.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFive">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        5. Will I get regular performance reports?
                                    </button>
                                </h2>
                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes. You receive monthly reports with traffic, leads, conversions, and ROI insights.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingSix">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                        6. Do you offer long-term digital marketing support?
                                    </button>
                                </h2>
                                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes. We work as a long-term growth partner for UAE businesses.
                                    </div>
                                </div>
                            </div>
                        </div>
