...
<body>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-6 col-md-3 mb-2 mb-md-0">
                    <div style="font-size: 28px; font-weight: 800; color: var(--color-primary);">150+</div>
                    <div style="font-size: 13px; color: #5f6368; font-weight: 500;">Apps Delivered</div>
                </div>
                <div class="col-6 col-md-3 mb-2 mb-md-0">
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">What We Do — App Development</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">From startup MVPs to enterprise-grade platforms, we build mobile and web apps that people actually want to use. Android, iOS, Flutter, or full-stack web applications — our developers handle the entire lifecycle from wireframes to deployment. With 150+ apps shipped across India, the US, UK, UAE, and Australia, we know how to build apps that scale. <a href="contact-us.php">Tell us about your app idea →</a></p>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">Trusted Custom App Development Company in India</h2>
                        <p class="mt-30">
                            ITD GrowthLabs is a leading app development company helping startups, SMEs, and enterprises build scalable mobile and web applications. From iOS and Android app development to custom web app solutions, we turn your ideas into high-performing apps.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row" style="display: flex; flex-wrap: wrap;">
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Professional Android and iOS apps that enhance engagement, strengthen brand presence, and improve retention.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Custom solutions with intuitive design, smooth performance, and seamless Apple ecosystem integration.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Robust apps with responsive UI, fast performance, and wide device compatibility.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Apps built using Flutter and React Native for seamless performance across Android and iOS.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Scalable, secure web applications accessible across devices with high performance.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="why-choose-card">
                        ...
                        <p>Solutions with secure payments, product catalogs, order management, and smooth user experience to boost sales.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">Complete Custom App Development Solutions</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); padding: 40px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3 style="color: #fff; margin: 0; font-size: 24px;">Ready to Build a Mobile App That Drives Business Growth?</h3>
                    <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0; font-size: 16px;">Schedule a free 30-minute discovery call with our app development team.</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center mb-4">
                    ...
                    <h2 style="font-weight: 700;">Apps That Drive Real Business Impact</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div style="background: #f8f9fa; border-radius: 12px; padding: 30px; height: 100%; border-top: 3px solid var(--color-primary);">
                        ...
                        <div style="font-size: 14px; color: #5f6368; font-weight: 600; margin-bottom: 15px;">Downloads in First 3 Months</div>
                        <p style="font-size: 14px; color: #3c4043; line-height: 1.7; margin-bottom: 12px;">"ITD GrowthLabs built our Flutter app from scratch and it hit 50,000 downloads within the first quarter. The UX design was spot-on — users loved it from day one."</p>
                        <div style="font-size: 13px; font-weight: 600; color: #202124;">— Health-Tech Startup, India</div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div style="background: #f8f9fa; border-radius: 12px; padding: 30px; height: 100%; border-top: 3px solid var(--color-primary);">
                        <div style="font-size: 32px; font-weight: 800; color: var(--color-primary); margin-bottom: 8px;">60%</div>
                        <div style="font-size: 14px; color: #5f6368; font-weight: 600; margin-bottom: 15px;">Reduction in Manual Processes</div>
                        <p style="font-size: 14px; color: #3c4043; line-height: 1.7; margin-bottom: 12px;">"The custom web app they built automated our entire order management workflow. We went from spreadsheets to a real-time dashboard that saved our team hours every day."</p>
                        <div style="font-size: 13px; font-weight: 600; color: #202124;">— Logistics Company, UAE</div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div style="background: #f8f9fa; border-radius: 12px; padding: 30px; height: 100%; border-top: 3px solid var(--color-primary);">
                        <div style="font-size: 32px; font-weight: 800; color: var(--color-primary); margin-bottom: 8px;">4.7★</div>
                        <div style="font-size: 14px; color: #5f6368; font-weight: 600; margin-bottom: 15px;">App Store Rating</div>
                        <p style="font-size: 14px; color: #3c4043; line-height: 1.7; margin-bottom: 12px;">"They didn't just build an app — they built something users actually enjoy. Our iOS app maintains a 4.7-star rating with consistent 5-star reviews on performance and design."</p>
                        <div style="font-size: 13px; font-weight: 600; color: #202124;">— FinTech Company, USA</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Trust Signals: App Dev Tools & Platforms -->
    <div style="background: #f8f9fa; padding: 40px 0; border-top: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0;">
        <div class="container">
            <div class="row align-items-center text-center">
                <div class="col-12 mb-3">
                    <h6 style="font-weight: 600; color: #5f6368; letter-spacing: 1px; font-size: 13px;">TECHNOLOGIES WE BUILD WITH</h6>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <div style="font-size: 13px; font-weight: 600; color: #202124;"><i class="fab fa-apple" style="font-size: 28px; color: #000; display: block; margin-bottom: 6px;"></i>iOS / Swift</div>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <div style="font-size: 13px; font-weight: 600; color: #202124;"><i class="fab fa-android" style="font-size: 28px; color: #3ddc84; display: block; margin-bottom: 6px;"></i>Android</div>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <div style="font-size: 13px; font-weight: 600; color: #202124;"><i class="fas fa-feather" style="font-size: 28px; color: #027dfd; display: block; margin-bottom: 6px;"></i>Flutter</div>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <div style="font-size: 13px; font-weight: 600; color: #202124;"><i class="fab fa-react" style="font-size: 28px; color: #61dafb; display: block; margin-bottom: 6px;"></i>React Native</div>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <div style="font-size: 13px; font-weight: 600; color: #202124;"><i class="fab fa-node-js" style="font-size: 28px; color: #339933; display: block; margin-bottom: 6px;"></i>Node.js</div>
                </div>
                <div class="col-6 col-md-2 mb-3">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">Behind Every Successful Business App</h2>
                        <p class="mt-30">We use modern and proven app development technologies to deliver fast, secure, and scalable mobile &amp; web apps — designed to grow your business.</p>
                    </div>
                </div>
            </div>
