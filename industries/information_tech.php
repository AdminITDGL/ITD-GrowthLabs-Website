...
<head>
    ...
    <base href="../">
    <meta name="description" content="Technology solutions for IT companies including SaaS development, web apps, SEO and lead generation for software firms and tech startups. ITD GrowthLabs.">
    <title>IT Industry Solutions | Software and Digital Services | ITD GrowthLabs</title>
    ...
    <meta name="twitter:title" content="IT Industry Solutions | Software and Digital Services | ITD GrowthLabs" />
    <meta name="twitter:description" content="Technology solutions for IT companies including SaaS development, web apps, SEO and lead generation for software firms and tech startups. ITD GrowthLabs." />
    ...
    <script type="application/ld+json">
    {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 2, "name": "Industries", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 3, "name": "IT Industry Solutions"}]}
    </script>
</head>
...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">IT & Technology Solutions</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">We work with SaaS companies, IT service providers, and tech startups to build product websites, developer portals, and marketing engines that drive demo requests and sign-ups. If you're in tech and your website isn't your best salesperson, we can fix that. <a href="../contact-us.php">Get a free tech consultation →</a></p>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); padding: 40px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3 style="color: #fff; margin: 0; font-size: 24px;">Ready to Scale Your IT Business with Digital Marketing?</h3>
                    <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0; font-size: 16px;">Schedule a free B2B growth strategy call with our team.</p>
                </div>
