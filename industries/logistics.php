...
<head>
    ...
    <title>Logistics App Development Company India | ITD GrowthLabs</title>
    ...
    <meta name="twitter:title" content="Logistics and Supply Chain IT Solutions | ITD GrowthLabs" />
    <meta name="twitter:description" content="IT solutions for logistics including fleet management apps, courier tracking, warehouse systems and digital marketing for logistics companies." />
    ...
    <script type="application/ld+json">
    {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 2, "name": "Industries", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 3, "name": "Logistics App Development Company India"}]}
    </script>
</head>
...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Logistics & Supply Chain Solutions</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">We build tracking platforms, fleet management apps, and lead-generating websites for logistics companies, freight forwarders, and supply chain businesses. Our digital marketing campaigns help logistics companies stand out in a crowded market and attract the right corporate clients. <a href="../contact-us.php">Let's optimize your digital presence →</a></p>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); padding: 40px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3 style="color: #fff; margin: 0; font-size: 24px;">Want to Digitize Your Logistics Operations &amp; Get More Clients?</h3>
                    <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0; font-size: 16px;">Talk to our logistics technology experts — free consultation.</p>
                </div>
