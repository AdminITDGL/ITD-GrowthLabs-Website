...
<head>
    ...
    <base href="../">
    <meta name="description" content="IT solutions for healthcare — custom apps, patient portals, telemedicine platforms & digital marketing for hospitals and clinics. ITD GrowthLabs.">
    <title>Healthcare IT Solutions & Digital Marketing | ITD GrowthLabs</title>
    ...
    <meta property="og:title" content="Healthcare Industry Digital Solutions | ITD GrowthLabs" />
    <meta property="og:description" content="Digital solutions for healthcare including HIPAA-compliant websites, patient portal apps, telemedicine platforms, and healthcare marketing services." />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://itdgrowthlabs.com/industries/healthcare.php" />
    <meta property="og:image" content="https://itdgrowthlabs.com/assets/img/logo.jpg" />
    <script type="application/ld+json">
    {"@context":"https://schema.org","@type":"Service","name":"Healthcare Industry Digital Solutions","description":"Website development, app development, and digital marketing for healthcare organizations.","provider":{"@type":"Organization","name":"ITD GrowthLabs","url":"https://itdgrowthlabs.com"},"areaServed":["India","Australia","UAE","UK","USA"],"serviceType":"Healthcare Industry Solutions"}
    </script>
    <script type="application/ld+json">
...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Quick Summary — Healthcare Digital Marketing &amp; App Development</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;"><strong>ITD GrowthLabs</strong> offers <strong>healthcare digital marketing</strong>, <strong>medical website development</strong>, and <strong>healthcare app development</strong> services. We help hospitals, clinics, and medtech companies across <strong>India, USA, UK, UAE, and Australia</strong> grow their patient base and online presence. <a href="../contact-us.php">Get a free healthcare marketing consultation</a>.</p>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); padding: 40px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3 style="color: #fff; margin: 0; font-size: 24px;">Need a Healthcare Website or Patient Acquisition Strategy?</h3>
