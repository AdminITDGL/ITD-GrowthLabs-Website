...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Healthcare Digital Solutions</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">We build HIPAA-aware websites, patient-facing apps, and digital marketing campaigns specifically for healthcare providers. Hospitals, clinics, diagnostics chains, and health-tech startups trust us because we understand the compliance requirements and patient journey unique to healthcare. <a href="../contact-us.php">Schedule a healthcare consultation →</a></p>
        </div>
    </div>
