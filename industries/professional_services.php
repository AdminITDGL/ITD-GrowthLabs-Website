...
<head>
    ...
    <base href="../">
    <meta name="description" content="IT solutions for professional services including CRM systems, client portals, websites and digital marketing for law firms, consultants and agencies.">
    <title>Professional Services IT Solutions | ITD GrowthLabs</title>
    ...
    <meta name="twitter:title" content="Professional Services IT Solutions | ITD GrowthLabs" />
    <meta name="twitter:description" content="IT solutions for professional services including CRM systems, client portals, websites and digital marketing for law firms, consultants and agencies." />
    ...
    <script type="application/ld+json">
    {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 2, "name": "Industries", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 3, "name": "Professional Services IT Solutions"}]}
    </script>
</head>
...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Professional Services Solutions</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">Law firms, consulting agencies, accounting practices, and recruitment firms trust us to build websites and run marketing campaigns that bring in high-value clients. We understand how professional services sell — through trust, credibility, and thought leadership — and we build that into everything. <a href="../contact-us.php">Let's grow your practice →</a></p>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); padding: 40px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3 style="color: #fff; margin: 0; font-size: 24px;">Want to Attract More High-Value Clients Online?</h3>
                    <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0; font-size: 16px;">Schedule a free strategy call with our professional services team.</p>
                </div>
