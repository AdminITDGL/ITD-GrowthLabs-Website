...
<head>
    ...
    <base href="../">
    <meta name="description" content="Digital solutions for manufacturing — ERP integration, supply chain apps, industrial websites & digital marketing for manufacturers. ITD GrowthLabs.">
    <title>Manufacturing IT Solutions & Digital Marketing | ITD GrowthLabs</title>
    ...
    <script type="application/ld+json">
    {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 2, "name": "Industries", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 3, "name": "Manufacturing IT Solutions & Digital Marketing"}]}
    </script>

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Manufacturing Industry Digital Solutions | ITD GrowthLabs" />
    <meta name="twitter:description" content="Digital solutions for manufacturing companies including websites, apps, and marketing strategies to boost efficiency and drive growth." />
...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Manufacturing Digital Solutions</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">We help manufacturers go digital with modern websites, B2B lead generation campaigns, and custom applications for production tracking and order management. Whether you're a factory looking for your first website or an enterprise modernizing operations, we speak your language. <a href="../contact-us.php">Discuss your manufacturing project →</a></p>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); padding: 40px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3 style="color: #fff; margin: 0; font-size: 24px;">Want More B2B Dealer Inquiries &amp; Digital Visibility?</h3>
