...
<head>
    ...
    <base href="../">
    <meta name="description" content="IT solutions for e-commerce including online store development, marketplace apps, SEO and digital marketing for e-commerce businesses. ITD GrowthLabs.">
    <title>E-commerce IT Solutions and Digital Marketing | ITD GrowthLabs</title>
    ...
    <meta name="twitter:title" content="E-commerce IT Solutions and Digital Marketing | ITD GrowthLabs" />
    <meta name="twitter:description" content="IT solutions for e-commerce including online store development, marketplace apps, SEO and digital marketing for e-commerce businesses. ITD GrowthLabs." />
    ...
    <script type="application/ld+json">
    {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 2, "name": "Industries", "item": "https://itdgrowthlabs.com/"}, {"@type": "ListItem", "position": 3, "name": "E-commerce IT Solutions and Digital Marketing"}]}
    </script>
</head>
...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">E-Commerce & D2C Digital Solutions</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">We help e-commerce brands and D2C companies build high-converting online stores, drive traffic through SEO and paid ads, and create apps that keep customers coming back. From Shopify and WooCommerce builds to full-stack custom platforms — we've helped 100+ e-commerce businesses grow their revenue online. <a href="../contact-us.php">Let's grow your store →</a></p>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title">From Concept to E-Commerce Success</h2>
                    </div>
                </div>
            </div>
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); padding: 40px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3 style="color: #fff; margin: 0; font-size: 24px;">Want to Increase Your Online Store Revenue &amp; Conversions?</h3>
                    <p style="color: rgba(255,255,255,0.85); margin: 8px 0 0; font-size: 16px;">Get a free e-commerce growth audit from our experts.</p>
                </div>
