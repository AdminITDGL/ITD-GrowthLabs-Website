...
<body>
    ...
    <div class="container mt-5 mb-3">
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e8f0fe 100%); border-left: 4px solid var(--color-primary); border-radius: 8px; padding: 25px 30px;">
            <h3 style="font-size: 20px; font-weight: 700; color: var(--color-primary); margin-bottom: 12px;">Finance & FinTech Solutions</h3>
            <p style="font-size: 15px; line-height: 1.8; color: #3c4043; margin: 0;">Banks, NBFCs, insurance companies, and fintech startups come to us for secure, compliant websites, trading platforms, and digital marketing that generates qualified leads. We understand the regulatory landscape and build solutions that meet industry standards while still converting visitors into customers. <a href="../contact-us.php">Let's discuss your finance project →</a></p>
        </div>
    </div>
    ...
    <div style="background: linear-gradient(135deg, var(--color-primary) 0%, #1a237e 100%); padding: 40px 0;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3 style="color: #fff; margin: 0; font-size: 24px;">Need a Secure Financial Platform or Lead Generation Campaign?</h3>
